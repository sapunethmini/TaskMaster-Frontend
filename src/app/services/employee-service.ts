...
export class EmployeeService {
  private apiUrl = environment.UserAuthUrl;
  private taskApiUrl = environment.TaskUrl;
  private departmentApiUrl = environment.DepartmentUrl; // Adjust URL as needed
  private roleApiUrl = environment.roleApiUrl; // Adjust URL as needed
